...
impl DataTable {
    ...
    pub fn two_way_without_reps(&self) -> ResultTwoWayWithoutReps //многофакторный дисперсионный анализ
    {
    ...
    pub fn one_way(&self, by_column: bool) -> ResultOneWay //однофакторный дисперсионный анализ
    {
        if by_column {
...
pub struct ResultTwoWayWithoutReps {
    ...
    pub ms: MSTwoWay,
    pub f: FTwoWay,
    pub p: PTwoWay, //f_crit: FCritTwoWay
}
#[derive(Debug)]
